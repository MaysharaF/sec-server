...
import Pagination from '../../specification/pagination/Pagination';
...
export abstract class BaseRepository<T> implements IBaseRepository<T> {
  ...
  async find(order?: {
    ...
    return await this.entity.find({ order });
  }
  ...
  async update(id: number, payload: QueryDeepPartialEntity<T>): Promise<T> {
  ...
  async findOne(
    ...
    return await this.entity.findOne({ where, order });
  }
